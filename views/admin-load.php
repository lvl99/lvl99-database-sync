                ...
                <tbody>
                  ...
                  <tr class="lvl99-dbs-filelist-file">
                    ...
                    <td class="lvl99-dbs-filelist-col-controls">
                      <a href="<?php echo site_url('/wp-admin/tools.php?page=lvl99-dbs&lvl99-dbs=download&lvl99-dbs_file='. urlencode($file['file_name'])); ?>" class="button button-secondary"><span class="fa fa-download"></span> <?php _ex('Download', 'button label download sql file', 'lvl99-dbs'); ?></a>
                      <a href="<?php echo site_url('/wp-admin/tools.php?page=lvl99-dbs&lvl99-dbs=delete&lvl99-dbs_file='.urlencode($file['file_name'])); ?>" class="button button-secondary deletion"><span class="fa fa-delete"></span> <?php _ex('Delete', 'button label delete sql file', 'lvl99-dbs'); ?></a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="lvl99-plugin-option-help" style="margin-top: 2em">
                ...
                <dl>
                  <dt>Home URL</dt>
                  <dd><code><?php echo home_url('/'); ?></code></dd>
                  <dt>Home Path</dt>
                  <dd><code><?php echo get_home_path(); ?></code></dd>
                  <dt>Site URL</dt>
                  <dd><code><?php echo site_url('/'); ?></code></dd>
                  <dt>Content Path:</dt>
                  <dd><code><?php echo $lvl99_dbs->content_dir(); ?></code></dd>
                  <dt>Uploads URL:</dt>
