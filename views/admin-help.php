...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="<?php echo trailingslashit(WP_SITEURL); ?>wp-admin/tools.php?page=lvl99-dbs&action=help" class="nav-tab nav-tab-active"><?php _ex('Help', 'Help page tab', 'lvl99-dbs'); ?></a>
	</h2>
