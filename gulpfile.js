...
// JavaScript bundlers
var app = new Bundler( './js', 'lvl99-dbs.dev.js', './js', 'lvl99-dbs.js' );
...
gulp.task('less', function () {
  return gulp.src(['./css/lvl99-dbs.less'])
    .pipe( less() )
    .pipe( prefix({
...
gulp.task('compressjs', ['jsdependencies', 'app'], function () {
  return gulp.src(['./js/lvl99-dbs.js',
                   './js/dependencies.js'])
    .pipe( uglify() )
    .pipe( rename({
      extname: '.min.js'
...
gulp.task('compresscss', ['less'], function () {
  return gulp.src(['./css/lvl99-dbs.css',
